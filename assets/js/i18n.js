...
(() => {
  ...
  "en": {
    ...
    "nav_ryokin": "Estimate Care Costs (Japanese)",
    "nav_about": "About Us",
    ...
    "ryo_b_title": "How much do care services cost for how many visits?",
    "ryo_b_sub": "Choose the care level and services to see an estimate of the monthly payment. You can try a schedule on a calendar (in Japanese)",
  ...
  "pt": {
    ...
    "nav_ryokin": "Estimar custos de cuidados (em japonês)",
    "nav_about": "Sobre Nós",
    ...
    "ryo_b_title": "Quantas vezes, quanto custa? Serviços de cuidados",
    "ryo_b_sub": "Escolha o nível de cuidado e os serviços para ver uma estimativa do pagamento mensal. Dá para testar a agenda num calendário (em japonês)",
